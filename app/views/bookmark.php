...
<head>
    ...
    <style>
        /* SCROLLBAR DIPERBESAR (Sama persis seperti halaman landing) */
            ...
            <div class="post-scroll flex-1 px-[20px] -mt-[15px] overflow-y-auto box-border w-full max-w-full m-0">
                ...
                <?php if (!empty($problems)): ?>
                    <?php foreach ($problems as $problem): ?>
                        <div class="bg-white border border-[#EEEEEE] rounded-[10px] shadow-[0_1px_6px_rgba(0,0,0,0.08)] overflow-hidden h-[170px] box-border flex flex-col mx-auto justify-between w-full max-w-[1200px] transition duration-200 hover:scale-[1.03] hover:shadow-[0_1px_6px_rgba(0,0,0,0.2)]" id="post-box-<?= $problem['id'] ?>">
                                ...
                                <div class="flex gap-[20px]">
                                    ...
                                    <span class="text-[13px] text-white m-0 p-0">
                                        <button class="bookmark-btn bg-transparent text-[#EEEEEE] font-semibold p-0 m-0 text-[13px] cursor-pointer inline-flex items-center gap-[5px] border-none group hover:text-[#00ADB5]" data-id="<?= $problem['id'] ?>">
                                            <iconify-icon icon="material-symbols:bookmark" style="color: #00ced1;" class="text-[20px] w-[20px] h-[20px] align-middle"></iconify-icon>
                                            Bookmark
                                        </button>
                                    </span>
                                    <span class="text-[13px] text-white m-0 p-0">
