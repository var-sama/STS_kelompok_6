                        ...
                        <div class="post" id="post-box-<?= $problem['id'] ?>">
                            ...
                            <div class="post-bottom">
                                <div class="actions">
                                    ...
                                    <span><button onclick="window.location.href='/problem-detail?id=<?= $problem['id'] ?>'"><svg class="icomment" width="18" height="18" viewBox="0 0 20 20" fill="" xmlns="http://www.w3.org/2000/svg">
