...
<body class="bg-[#f6f7fb] flex h-screen font-sans overflow-hidden">
    ...
    <aside class="bg-sidebar w-[320px] flex flex-col text-white shadow-2xl z-10">
        ...
        <nav class="flex-1 mt-2">
            <ul>
                <li class="relative flex items-center h-14 bg-gray-800/40">
                    <div class="absolute left-0 top-0 bottom-0 w-1 bg-[#00ced1]"></div>
                    <span class="pl-8 font-bold text-white uppercase tracking-wider text-sm">Lomen</span>
                </li>
                <li class="flex items-center h-14 hover:bg-gray-800/20 cursor-pointer transition">
                    <span class="pl-8 text-gray-400 uppercase tracking-wider text-sm">Anggota</span>
                </li>
                <li class="flex items-center h-14 hover:bg-gray-800/20 cursor-pointer transition">
                    <span class="pl-8 text-gray-400 uppercase tracking-wider text-sm">Proyek</span>
                </li>
            </ul>
        </nav>
    </aside>
    ...
    <main class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto p-8 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden max-w-4xl mx-auto transition-all duration-200 hover:scale-[1.03] hover:shadow-md cursor-pointer">
                ...
                <div class="post-bottom bg-action-bar px-6 py-3 flex items-center justify-between text-white">
                    <div class="actions flex items-center">
                        <span class="mr-4 text-[13px]">
                            <button><iconify-icon icon="mdi:like-outline"></iconify-icon>Like</button>
                        </span>
                        <span class="mr-4 text-[13px]">
                            <button><iconify-icon icon="mdi:share"></iconify-icon>Share</button>
                        </span>
                        <span class="mr-4 text-[13px]">
                            <button><iconify-icon icon="material-symbols:bookmark-outline"></iconify-icon>Bookmark</button>
                        </span>
